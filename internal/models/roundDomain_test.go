...
func Test_RoundTotalScore(t *testing.T) {
	...
	club = Club{ClubName: "Driver"}
	hole.RecordShot(ShotTypeTee, club, LocationOutOfBounds, "", StrikeQualityClean, "")
...
func Test_GreenInRegulation(t *testing.T) {
	...
	club := Club{ClubName: "Driver"}
	hole.RecordShot(ShotTypeTee, club, LocationGreen, "", StrikeQualityClean, "")
	...
	club = Club{ClubName: "Driver"}
	hole.RecordShot(ShotTypeTee, club, LocationFairway, "", StrikeQualityClean, "")
	hole.RecordShot(ShotTypeChip, club, LocationGreen, "", StrikeQualityClean, "")
	...
	hole.RecordShot(ShotTypeTee, club, LocationFairway, "", StrikeQualityClean, "")
	hole.RecordShot(ShotTypeApproach, club, LocationFairway, "", StrikeQualityClean, "")
	hole.RecordShot(ShotTypePitch, club, LocationGreen, "", StrikeQualityClean, "")
	...
	club = Club{ClubName: "Driver"}
	hole.RecordShot(ShotTypeTee, club, LocationGreen, "", StrikeQualityClean, "")
	hole.RecordShot(ShotTypeLayup, club, LocationFairway, "", StrikeQualityClean, "")
	hole.RecordShot(ShotTypeApproach, club, LocationGreen, "", StrikeQualityClean, "")
